...
(1,'Ingrid Fatima','Santana Sardi','1257894562','femenino','052487896','0982222222','ingrid@hotmail.com','C',0,0,0),
(2,'Fabián Alberto','Hidalgo Tigua','1257894585','masculino','05249896','0921111111','fabian@hotmail.com','B',1,0,0),
(3,'Liseth María','Jonioux Delgado','1285294585','femenino','052498876','0925555555','lissette@hotmail.com','B',0,0,0),
(4,'Orley Sebastian','Montanero Alcivar','1257874521','masculino','052748562','0983333333','orley@hotmail.com','C',1,0,0),
(5,'Jennifer María','Chávez Macías','1524789658','femenino','052452789','0927777777','jennifer@hotmail.com','C',1,0,0);


insert into marcavehiculo values (1,'hyundai'),(2,'chevrolet'),(3,'great wall'),(4,'toyota'),(5,'nissan'),(6,'kia');

insert into vehiculo values(1,1,90,'PZX-955','01-01-2020','24-12-2019',0),(2,2,85,'ABC-123','03-03-2020','06-05-2020',0),
						   (3,3,120,'MAB-444-','02-02-2020','11-10-2019',0),(4,4,200,'XBA-987','03-04-2020','05-05-2020',0);
